-- EDMarketplace MySQL schema
-- User roles (Consumer / Prosumer / SmartUser), algorithm developer config, and registration tables
-- backing the EDMarketplace peer-to-peer energy marketplace UI.
