...
{
    public class ProposeNewDToDP: ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            nMessage.PCause = ProposalCause.NewDomainToDP;
    ...
    public class SaveNewDToNewDToDP : ICommand
    {
        public event EventHandler CanExecuteChanged;
    ...
    public class AddNewDToDP : INotifyPropertyChanged
    {
        ...
        ProposeNewDToDP pnDT;
        public ProposeNewDToDP PnDT
        {
            get
            {
                if(pnDT != null)
                {
                    pnDT = new ProposeNewDToDP();
                    pnDT.RaisePropose += PnDT_RaisePropose;
                }
                return pnDT;
            }
        }

        SaveNewDToNewDToDP svDT;
        public SaveNewDToNewDToDP SvDT
        {
            get
            {
                if(SvDT != null)
                {
                    svDT = new SaveNewDToNewDToDP();
                    svDT.RaisePropose += PnDT_RaisePropose;
                }
                return svDT;
            }
        }
        ...
        private void PnDT_RaisePropose(object sender, ProposeEventArgs e)
        {
