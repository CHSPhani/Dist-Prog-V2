...
{
    public class ProposeNewRstr:ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            nMessage.PCause = ProposalCause.NewRstr;
    ...
    public class SaveNewRstr : ICommand
    {
        public event EventHandler CanExecuteChanged;
    ...
    public class AddNewRstr : INotifyPropertyChanged
    {
        ...
        ProposeNewRstr pnRstr;

        public ProposeNewRstr PNRStr
        {
            get
            {
                if(pnRstr == null)
                {
                    pnRstr = new ProposeNewRstr();
                    pnRstr.RaisePropose += PnRstr_RaisePropose;
                }
                return pnRstr;
            }
        ...
        public SaveNewRstr SNRstr
        {
            get
            {
                if(snRstr == null)
                {
                    snRstr = new SaveNewRstr();
                    snRstr.RaisePropose += PnRstr_RaisePropose;
                }
                return snRstr;
            }
        }

        private void PnRstr_RaisePropose(object sender, ProposeEventArgs e)
        {
        ...
        public AddNewRstr(string uName, DBData dbData)
        {
